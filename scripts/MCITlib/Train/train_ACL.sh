...
bash scripts/MCITlib/Train/Task1.sh \
    ...
    $HARD_PATH/configs/train_configs/proglora/LLaVA/MLLM-ACL/train/task1.json
...
bash scripts/MCITlib/Train/Taskn.sh \
    ...
    $HARD_PATH/configs/train_configs/proglora/LLaVA/MLLM-ACL/train/task2.json
...
bash scripts/MCITlib/Train/Taskn.sh \
    ...
    $HARD_PATH/configs/train_configs/proglora/LLaVA/MLLM-ACL/train/task3.json
...
bash scripts/MCITlib/Train/Taskn.sh \
    ...
    $HARD_PATH/configs/train_configs/proglora/LLaVA/MLLM-ACL/train/task4.json
